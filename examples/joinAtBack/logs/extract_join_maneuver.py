...
Usage:
    python3 extract_join_maneuver.py omnetpp_JoinAtBackFull.log -o join_semantics.log

Include every CarlaJoinAtBack beacon line:
    python3 extract_join_maneuver.py omnetpp_JoinAtBackFull.log -o join_semantics.log --all-beacons
"""
