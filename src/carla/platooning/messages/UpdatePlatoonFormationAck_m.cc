//
// Generated file, do not edit! Created by opp_msgtool 6.0 from carla/platooning/messages/UpdatePlatoonFormationAck.msg.
//
...
size_t UpdatePlatoonFormationAck::getPlatoonFormationArraySize() const
{
    return platoonFormation_arraysize;
}

int UpdatePlatoonFormationAck::getPlatoonFormation(size_t k) const
{
...
void UpdatePlatoonFormationAck::setPlatoonFormationArraySize(size_t newSize)
{
...
void UpdatePlatoonFormationAck::setPlatoonFormation(size_t k, int platoonFormation)
{
    if (k >= platoonFormation_arraysize) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)platoonFormation_arraysize, (unsigned long)k);
    this->platoonFormation[k] = platoonFormation;
}

void UpdatePlatoonFormationAck::insertPlatoonFormation(size_t k, int platoonFormation)
{
    if (k > platoonFormation_arraysize) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)platoonFormation_arraysize, (unsigned long)k);
...
void UpdatePlatoonFormationAck::appendPlatoonFormation(int platoonFormation)
{
    insertPlatoonFormation(platoonFormation_arraysize, platoonFormation);
}

void UpdatePlatoonFormationAck::erasePlatoonFormation(size_t k)
{
    if (k >= platoonFormation_arraysize) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)platoonFormation_arraysize, (unsigned long)k);
    size_t newSize = platoonFormation_arraysize - 1;
    int *platoonFormation2 = (newSize == 0) ? nullptr : new int[newSize];
...
UpdatePlatoonFormationAckDescriptor::UpdatePlatoonFormationAckDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(UpdatePlatoonFormationAck)), "ManeuverMessage")
{
...
int UpdatePlatoonFormationAckDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    UpdatePlatoonFormationAck *pp = omnetpp::fromAnyPtr<UpdatePlatoonFormationAck>(object); (void)pp;
    switch (field) {
...
void UpdatePlatoonFormationAckDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'UpdatePlatoonFormationAck'", field);
    }
}

const char *UpdatePlatoonFormationAckDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string UpdatePlatoonFormationAckDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void UpdatePlatoonFormationAckDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'UpdatePlatoonFormationAck'", field);
    }
}

omnetpp::cValue UpdatePlatoonFormationAckDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'UpdatePlatoonFormationAck' as cValue -- field index out of range?", field);
    }
}

void UpdatePlatoonFormationAckDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::any_ptr UpdatePlatoonFormationAckDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void UpdatePlatoonFormationAckDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
